...
function Male(){
    return(
        <main className="main-container"> Male
        <div className="position:fixed;z-index:9999;top:16px;left:16px;right:16px;bottom:16px;pointer-events:none">
        </div>
        <div className="Allproducts-container flex gap-10 px-10">

        <div className="Allproduct-card">
        <Image src="https://cdn.sanity.io/images/dow10h3v/production/4e2ed6a9eaa6e1413843e53f3113ccfd2104c301-278x296.png" width="250" height="270" alt="male">
        </Image>
        ...
        <div className="Allproduct-card">
        <Image src="https://cdn.sanity.io/images/dow10h3v/production/2228e40aa700a68031eff4016f9e625ade813a89-278x296.png" width="250" height="270" alt="male">
        </Image>
